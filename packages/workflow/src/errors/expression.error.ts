...
export const EXPRESSION_ERROR_MESSAGES = {
	nodeNotFound: 'Error finding the referenced node',
	nodeReferenceTemplate:
...
export const EXPRESSION_ERROR_TYPES = {
	pairedItemNoConnection: 'paired_item_no_connection',
} as const;

export const EXPRESSION_DESCRIPTION_KEYS = {
	nodeNotFound: 'nodeNotFound',
	noNodeExecutionData: 'noNodeExecutionData',
	pairedItemNoConnection: 'pairedItemNoConnection',
	pairedItemNoConnectionCodeNode: 'pairedItemNoConnectionCodeNode',
} as const;
