...
export const stringExtensions: ExtensionMap = {
	typeName: 'String',
	functions: {
		hash: hash as Extension,
		removeMarkdown: removeMarkdown as Extension,
		removeTags: removeTags as Extension,
		toDate: toDate as Extension,
		toDateTime: toDateTime as Extension,
		toBoolean: toBoolean as Extension,
		toDecimalNumber,
		toNumber: toNumber as Extension,
		toFloat: toFloat as Extension,
		toInt: toInt as Extension,
		toWholeNumber,
		toSentenceCase: toSentenceCase as Extension,
		toSnakeCase: toSnakeCase as Extension,
		toTitleCase: toTitleCase as Extension,
		urlDecode: urlDecode as Extension,
		urlEncode: urlEncode as Extension,
		quote: quote as Extension,
		replaceSpecialChars: replaceSpecialChars as Extension,
		length: length as Extension,
		isDomain: isDomain as Extension,
		isEmail: isEmail as Extension,
		isNumeric: isNumeric as Extension,
		isUrl: isUrl as Extension,
		isEmpty: isEmpty as Extension,
		isNotEmpty: isNotEmpty as Extension,
		toJsonString: toJsonString as Extension,
		extractEmail: extractEmail as Extension,
		extractDomain: extractDomain as Extension,
		extractUrl: extractUrl as Extension,
		extractUrlPath: extractUrlPath as Extension,
		parseJson: parseJson as Extension,
		base64Encode: base64Encode as Extension,
		base64Decode: base64Decode as Extension,
	},
};
