...
export const arrayExtensions: ExtensionMap = {
	...
	functions: {
		removeDuplicates,
		unique: unique as Extension,
		first: first as Extension,
		last: last as Extension,
		pluck: pluck as Extension,
		randomItem: randomItem as Extension,
		sum: sum as Extension,
		min: min as Extension,
		max: max as Extension,
		average: average as Extension,
		isNotEmpty: isNotEmpty as Extension,
		isEmpty: isEmpty as Extension,
		compact: compact as Extension,
		smartJoin: smartJoin as Extension,
		chunk: chunk as Extension,
		renameKeys: renameKeys as Extension,
		merge: merge as Extension,
		union: union as Extension,
		difference: difference as Extension,
		intersection: intersection as Extension,
		append: append as Extension,
